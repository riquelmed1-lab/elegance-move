...
for(const marker of ['ELEGANCE_MOVE_CLIENTS_MOBILE_RUNTIME_V1','isClients','Cadastro organizado','+ Novo cliente']) if(!js.includes(marker)) throw new Error(`Clients mobile JS incompleto: ${marker}`);
...
new Function(js);
console.log('CLIENTS_MOBILE_VERIFIED',{cssBytes:Buffer.byteLength(css),jsBytes:Buffer.byteLength(js)});
