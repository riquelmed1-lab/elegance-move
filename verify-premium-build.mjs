...
const requiredFiles=['public/index.html','public/premium-theme.css','public/premium-fidelity.css','public/premium-hotfix.css','public/premium-cleanup.css','public/product-images.css','public/mobile-app.css','public/mobile-polish.css','public/premium-theme.js','public/premium-hotfix.js','public/premium-cleanup.js','public/mobile-app.js','public/premium-fashion.svg','public/auth.js','public/password-recovery.js','public/users-ui.js','public/manifest.webmanifest','public/elegance-move-rose-gold-v9.png','public/pwa-runtime.js','public/sw.js','api/product-image.js'];
for(const file of requiredFiles) await access(file);

const [html,baseCss,fidelity,hotfixCss,cleanupCss,productImagesCss,mobileCss,mobilePolish,js,hotfixJs,cleanupJs,mobileJs,svg,authJs,passwordJs,usersJs,manifest,pwaIcon,pwaRuntime,serviceWorker,productImageApi]=await Promise.all([
  readFile('public/index.html','utf8'),readFile('public/premium-theme.css','utf8'),readFile('public/premium-fidelity.css','utf8'),readFile('public/premium-hotfix.css','utf8'),readFile('public/premium-cleanup.css','utf8'),readFile('public/product-images.css','utf8'),readFile('public/mobile-app.css','utf8'),readFile('public/mobile-polish.css','utf8'),readFile('public/premium-theme.js','utf8'),readFile('public/premium-hotfix.js','utf8'),readFile('public/premium-cleanup.js','utf8'),readFile('public/mobile-app.js','utf8'),readFile('public/premium-fashion.svg','utf8'),readFile('public/auth.js','utf8'),readFile('public/password-recovery.js','utf8'),readFile('public/users-ui.js','utf8'),readFile('public/manifest.webmanifest','utf8'),readFile('public/elegance-move-rose-gold-v9.png'),readFile('public/pwa-runtime.js','utf8'),readFile('public/sw.js','utf8'),readFile('api/product-image.js','utf8')
]);

const htmlMarkers=['id="elegance-premium-critical"','id="elegance-premium-runtime"','id="elegance-mobile-app"','id="elegance-mobile-app-runtime"','/auth.js','/password-recovery.js','/users-ui.js','Faturamento do mês','Lucro líquido do mês','Hard SVG isolation','sanitizeMetricSvg','ELEGANCE_MOVE_CLEANUP_V1','ELEGANCE_MOVE_MOBILE_FIX_V2','ELEGANCE_MOVE_PRODUCT_IMAGES_V1','ELEGANCE_MOVE_MOBILE_APP_V1','ELEGANCE_MOVE_MOBILE_POLISH_V1','premium-financial-duplicate','id="productPhotoInput"','product-photo-stock','product-photo-sale','manifest.webmanifest?v=9','id="elegance-pwa-launch"','id="emPwaSplash"','/pwa-runtime.js','elegance-move-rose-gold-v9.png'];
...
for(const marker of ['"display": "standalone"','elegance-move-rose-gold-v9.png','"sizes": "180x180"']) if(!manifest.includes(marker)) throw new Error(`Manifest PWA incompleto: ${marker}`);
if(pwaIcon.length<5000||pwaIcon[0]!==0x89||pwaIcon[1]!==0x50||pwaIcon[2]!==0x4e||pwaIcon[3]!==0x47) throw new Error('Ícone rose gold PWA inválido');
const iconWidth=pwaIcon.readUInt32BE(16),iconHeight=pwaIcon.readUInt32BE(20);
if(iconWidth!==180||iconHeight!==180) throw new Error(`Ícone rose gold deve ser 180x180, got ${iconWidth}x${iconHeight}`);
...
for(const marker of ['/api/','APP_SHELL']) if(!serviceWorker.includes(marker)) throw new Error(`Service worker incompleto: ${marker}`);
