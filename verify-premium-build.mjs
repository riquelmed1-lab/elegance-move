...
const requiredFiles=['public/index.html','public/premium-theme.css','public/premium-fidelity.css','public/premium-hotfix.css','public/premium-cleanup.css','public/product-images.css','public/premium-theme.js','public/premium-hotfix.js','public/premium-cleanup.js','public/premium-fashion.svg','public/auth.js','public/password-recovery.js','public/users-ui.js','api/product-image.js'];
for(const file of requiredFiles) await access(file);

const [html,baseCss,fidelity,hotfixCss,cleanupCss,productImagesCss,js,hotfixJs,cleanupJs,svg,authJs,passwordJs,usersJs,productImageApi]=await Promise.all([
  readFile('public/index.html','utf8'),readFile('public/premium-theme.css','utf8'),readFile('public/premium-fidelity.css','utf8'),readFile('public/premium-hotfix.css','utf8'),readFile('public/premium-cleanup.css','utf8'),readFile('public/product-images.css','utf8'),readFile('public/premium-theme.js','utf8'),readFile('public/premium-hotfix.js','utf8'),readFile('public/premium-cleanup.js','utf8'),readFile('public/premium-fashion.svg','utf8'),readFile('public/auth.js','utf8'),readFile('public/password-recovery.js','utf8'),readFile('public/users-ui.js','utf8'),readFile('api/product-image.js','utf8')
]);

const htmlMarkers=['id="elegance-premium-critical"','id="elegance-premium-runtime"','/auth.js','/password-recovery.js','/users-ui.js','Faturamento do mês','Lucro líquido do mês','Hard SVG isolation','sanitizeMetricSvg','ELEGANCE_MOVE_CLEANUP_V1','ELEGANCE_MOVE_MOBILE_FIX_V2','ELEGANCE_MOVE_PRODUCT_IMAGES_V1','premium-financial-duplicate','id="productPhotoInput"','product-photo-stock','product-photo-sale'];
...
const cssAll=baseCss+fidelity+hotfixCss+cleanupCss+productImagesCss;
const cssMarkers=['.premium-side-story','.premium-brand-card','.premium-sparkline','.premium-donut','Hard SVG isolation','ELEGANCE_MOVE_CLEANUP_V1','ELEGANCE_MOVE_MOBILE_FIX_V2','ELEGANCE_MOVE_PRODUCT_IMAGES_V1','#logoutBtn','premium-lower-2 .list-row-main','premium-lower-3 .list-row','.product-photo-editor','.product-photo-stock','.product-photo-sale','premium-financial-duplicate','grid-template-columns:repeat(4,minmax(0,1fr))','@media(max-width:1024px)','@media(max-width:760px)','@media(max-width:480px)'];
