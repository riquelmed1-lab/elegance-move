...
for(const marker of ['function productPhotoMarkup(url,name,extraClass)','function compressProductPhoto(file)','function uploadProductPhoto(productId,file)','/api/product-image','previousUrl','id="productPhotoInput"','imageUrl};','product-photo-stock','product-photo-sale','dashboard-product-photo',"console.warn('Falha ao limpar foto do produto'"]){
