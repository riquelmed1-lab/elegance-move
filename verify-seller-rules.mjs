...
const current={
  ...
  sales:[{id:'s1',clientId:'c1',client:'Cliente Original',date:'2026-09-01',payment:'Pix',lines:[{productId:'p1',product:'Conjunto Move',size:'M',color:'Preto',category:'Conjunto',unitPrice:100,unitCost:50,qty:1}],subtotal:100,discountAmount:0,total:100,items:1}],
...
const incoming={
  ...
  sales:[
    ...
    {id:'s2',clientId:'c1',client:'texto não confiável',date:'2026-09-17',payment:'Pix',lines:[{productId:'p1',qty:2,unitPrice:1,unitCost:0}],discountAmount:10}
  ],
...
console.log('SELLER_RULES_VERIFIED',{historicalSalesImmutable:true,clientDeletionBlocked:true,canonicalPricing:true,stockProtected:true,quotesPreserved:true,counterMonotonic:true});
