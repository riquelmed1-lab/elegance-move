...
const SPLASH_ICON='/elegance-move-rose-gold-v10.png';
const FAVICON='/pwa-icon-192.png';
const APPLE_ICON='/apple-touch-icon.png';
const MANIFEST='/manifest.webmanifest?v=10';
...
<link rel="apple-touch-icon-precomposed" sizes="180x180" href="${APPLE_ICON}">
...
html=html
  ...
  .replace(/<link rel="apple-touch-icon(?:-precomposed)?"[^>]*>\s*/g,'')
...
const splash=`<div id="emPwaSplash" aria-hidden="true"><div class="em-splash-inner"><img class="em-splash-icon" src="${SPLASH_ICON}" alt=""><div class="em-splash-name">Elegance Move</div><div class="em-splash-tag">Gestão inteligente da sua loja</div><div class="em-splash-loader"></div></div></div>`;
...
for(const marker of ['manifest.webmanifest?v=10','apple-mobile-web-app-capable','apple-touch-icon-precomposed','pwa-runtime.js','theme-color','emPwaSplash','elegance-pwa-launch','elegance-move-rose-gold-v10.png','pwa-icon-192.png']){
...
console.log('PWA_PATCH_OK',{indexBytes:Buffer.byteLength(html),splash:true,placement:'safe',version:10,icons:{favicon:FAVICON,apple:APPLE_ICON,splash:SPLASH_ICON}});
