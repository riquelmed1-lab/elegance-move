...
for(const marker of ['ELEGANCE_MOVE_SALES_MOBILE_V1','ELEGANCE_MOVE_SALES_MOBILE_V2','em-sales-screen','em-sales-metrics','em-sales-primary','em-sales-metric-card','em-sales-context','font-size:9.5px','font-size:8.5px']) if(!css.includes(marker)) throw new Error(`Sales mobile CSS incompleto: ${marker}`);
...
new Function(js);
console.log('SALES_MOBILE_VERIFIED',{cssBytes:Buffer.byteLength(css),jsBytes:Buffer.byteLength(js),version:3,legibilityFloor:true});
