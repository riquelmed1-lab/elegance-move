...
const [css,polish,js]=await Promise.all([readFile(cssPath,'utf8'),readFile(polishPath,'utf8'),readFile(jsPath,'utf8')]);
...
console.log('MOBILE_APP_INLINE_OK',{cssBytes:Buffer.byteLength(css)+Buffer.byteLength(polish),jsBytes:Buffer.byteLength(js),indexBytes:Buffer.byteLength(html)});
